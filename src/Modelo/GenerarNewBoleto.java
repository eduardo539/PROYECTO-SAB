...
//Clase para guardar los datos que se mostraran en la tabla
public class GenerarNewBoleto {
    
    
    private static GenerarNewBoleto instancia; // Instancia única de la clase
    ...
    private GenerarNewBoleto() {
        listaDatos = new ArrayList<>();
    }
    
    
    // Método para obtener la instancia única de la clase
    public static GenerarNewBoleto getInstancia() {
        if (instancia == null) {
            instancia = new GenerarNewBoleto();
        }
        return instancia;
    }
    ...
    public static class DataPDF{
        ...
        public DataPDF(int Folio, int Origen, int Grupo, int NumSocio, String Nombre, String sucursal, String Invitado, String Telefono, String Zona, String DescMesa, String vchDescripcion, String FechaVigencia) {
            this.Folio = Folio;
            this.Origen = Origen;
            this.Grupo = Grupo;
