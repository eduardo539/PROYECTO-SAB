...
public class AyudaPosadaMonterrey extends javax.swing.JFrame {

    public AyudaPosadaMonterrey() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ayuda posada monterrey CAJERO");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AyudaPosadaMonterrey().setVisible(true);
            }
        });
    }
