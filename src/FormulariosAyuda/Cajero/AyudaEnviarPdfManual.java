...
public class AyudaEnviarPdfManual extends javax.swing.JFrame {
    
    public AyudaEnviarPdfManual() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ayuda enviar pdf manual  CAJERO");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AyudaEnviarPdfManual().setVisible(true);
            }
        });
    }
