...
public class AyudaVentaXSucursales extends javax.swing.JFrame {

    public AyudaVentaXSucursales() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ayuda Ventas X Sucursales OPERACIONES");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AyudaVentaXSucursales().setVisible(true);
            }
        });
    }
