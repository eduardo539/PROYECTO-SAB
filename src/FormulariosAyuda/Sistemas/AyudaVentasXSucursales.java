...
public class AyudaVentasXSucursales extends javax.swing.JFrame {

    public AyudaVentasXSucursales() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ayuda Ventas X Sucursales SISTEMAS");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AyudaVentasXSucursales().setVisible(true);
            }
        });
    }
