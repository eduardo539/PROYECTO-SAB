...
CREATE TABLE `fechalimite` (
  `idFecha` bigint(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `saldosocio` (
  `idSaldo` bigint(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sesiones` (
  `idSesion` bigint(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_bit_accion_usuarios` (
  `id_reg` bigint(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_boletos` (
  `Folio` bigint(11) NOT NULL AUTO_INCREMENT,
  `Origen` int(11) NOT NULL,
  `Grupo` int(11) NOT NULL,
...
insert  into `tbl_usuarios`(`id_usuario`,`Nombre`,`vchPass`,`dtVigencia`,`id_perfil`,`estado`) values (539,'Eduardo Dominguez','0b2bc677c3134d7df60d60f4cabf828e','2025-05-15',1,'activo');
